            ...
            <div class="card card-primary">
              ...
              <form method="post">
                ...
                if (isset($_POST['submit']))
                {
                  ...
                  // $stmt->bindParam(":direccion_pedido",$_POST["direccion_pedido"],PDO::PARAM_STR);
                  // $stmt->bindParam(":fecha_pedido",$_POST["fecha_pedido"],PDO::PARAM_STR);
                  // $stmt->bindParam(":estado_pedido",$_POST["estado_pedido"],PDO::PARAM_STR);
                  // $stmt->bindParam(":detalle_pedido",$_POST["detalle_pedido"],PDO::PARAM_STR);
                  // $stmt->bindParam(":IdCliente",$_POST["idCliente"],PDO::PARAM_INT);
